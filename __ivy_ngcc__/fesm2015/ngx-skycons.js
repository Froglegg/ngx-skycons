...
class SkyconsComponent {
  constructor() {
    ...
    this.caf = window.cancelAnimationFrame || window.webkitCancelAnimationFrame;
    this.WIND_PATHS = [
      [
        -0.75,
        -0.18,
  ...
  puffs(ctx, t, cx, cy, rx, ry, rmin, rmax) {
    /** @type {?} */
    let i;
    for (i = 5; i--; ) this.puff(ctx, t + i / 5, cx, cy, rx, ry, rmin, rmax);
  }
  /**
   * @private
   * @param {?} ctx
  ...
  fog(ctx, t, color) {
    ...
    /** @type {?} */
    let c = Math.cos((t + 0.5) * TAU) * s * 0.02;
    /** @type {?} */
  ...
  draw(obj, time) {
    ...
    if (this.weather.includes("DAY") && this.weather.includes("CLOUD")) {
      ...
      this.weather.includes("NIGHT") &&
      this.weather.includes("CLOUD")
    ) {
  ...
  play() {
    ...
    this.interval = this.requestInterval(
      ...
      () => {
        ...
        /** @type {?} */
        let i;
        for (i = this.list.length; i--; ) this.draw(this.list[i], now);
      },
      1000 / 60
    );
  }
...
SkyconsComponent.ɵfac = function SkyconsComponent_Factory(t) {
  return new (t || SkyconsComponent)();
};
SkyconsComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({
  type: SkyconsComponent,
  selectors: [["sc-skycons"]],
  viewQuery: function SkyconsComponent_Query(rf, ctx) {
    if (rf & 1) {
  ...
  template: function SkyconsComponent_Template(rf, ctx) {
    if (rf & 1) {
...
SkyconsModule.ɵinj = ɵngcc0.ɵɵdefineInjector({
  factory: function SkyconsModule_Factory(t) {
    return new (t || SkyconsModule)();
  },
  imports: [[]],
});
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) &&
    ɵngcc0.ɵɵsetNgModuleScope(SkyconsModule, {
