...
SkyconsComponent.ɵfac = function SkyconsComponent_Factory(t) { return new (t || SkyconsComponent)(); };
SkyconsComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: SkyconsComponent, selectors: [["sc-skycons"]], viewQuery: function SkyconsComponent_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(_c0, true);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.canvas = _t.first);
    } }, inputs: { color: "color", weather: "weather", resizeClear: "resizeClear", width: "width" }, features: [ɵngcc0.ɵɵNgOnChangesFeature()], decls: 2, vars: 0, consts: [[1, "skycons__canvas"], ["skyconCanvas", ""]], template: function SkyconsComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(SkyconsComponent, [{
        type: Component,
        args: [{
                selector: 'sc-skycons',
                template: `
...
SkyconsModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: SkyconsModule });
SkyconsModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function SkyconsModule_Factory(t) { return new (t || SkyconsModule)(); }, imports: [[]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(SkyconsModule, { declarations: [SkyconsComponent], exports: [SkyconsComponent] }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(SkyconsModule, [{
        type: NgModule,
        args: [{
